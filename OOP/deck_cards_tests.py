from desk_of_card import Card, Deck
import unittest
...
class CardTests(unittest.TestCase):
    ...
    def test_repr(self):
        """repr should be return a string of the form 'VALUE of SUIT"""
...
class DeckTest(unittest.TestCase):
    ...
    def test_deal_insufficient_cards(self):
        """deal should deal the number of cards left in the ..."""
        cards = self.deck._deal(100)
        self.assertEqual(len(cards), 52)
        self.assertEqual(self.deck.count(), 0)
    
    def test_deal_no_cards(self):
        """_deal should throw a ValueError if the deck is e"""
    ...
    def test_shuffle_full_deck(self):
        cards = self.deck.cards[:] #make a copy
        self.deck.shuffle()
